...
This directory contains comprehensive implementation guides for HA Light Controller development.
...
**Q: How do I distribute the integration?**
A: Follow [HACS_INTEGRATION.md](HACS_INTEGRATION.md) after achieving Bronze tier minimum.

**Q: The integration is slow. How do I optimize it?**
A: Review [PERFORMANCE.md](PERFORMANCE.md) for optimization strategies.
...
**Q: I need to change the config entry structure. How?**
...
- **Integration Code**: [../custom_components/ha_light_controller/](../custom_components/ha_light_controller/)
